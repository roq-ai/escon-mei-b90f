...
import { getNotaFiscalById } from 'apiSdk/nota-fiscals';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Nota Fiscal Detail View
          </Text>
          {hasAccess('nota_fiscal', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/nota-fiscals/edit/${data?.id}`} passHref legacyBehavior>
              <Button
            ...
            <Stack direction="column" spacing={2} mb={4}>
              <Flex alignItems="center">
                ...
                <Text fontSize="md" as="span" ml={3}>
                  {data?.issue_date as unknown as string}
                </Text>
              </Flex>
              <Flex alignItems="center">
                <Text fontSize="lg" fontWeight="bold" as="span">
